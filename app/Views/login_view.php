    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form method="post">
          ...
          <?php if($page_session->get('success')): ?>
              <div class="alert alert-success"><?= $page_session->get('success')?></div>
          <?php endif ?>
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="<?= base_url()?>/signup"
